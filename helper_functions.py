...
def modelscore(y_true,y_pred):
     f1=(format(f1_score(y_true=y_true,y_pred=y_pred),".2f"))
     recall=(format(recall_score(y_true=y_true,y_pred=y_pred),".2f"))
     pre=(format(precision_score(y_true=y_true,y_pred=y_pred),".2f"))
     acc=(format(accuracy_score(y_true=y_true,y_pred=y_pred)*100,".2f"))
     dic={"Accuracy":acc,"f1-score":f1,"Recall":recall,"Precision":pre}
     return dic
     
def modelscore2(y_true,y_pred):
